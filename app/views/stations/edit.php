    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <form action="<?= url('station/edit/' . $station->id) ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" 
                                           value="<?= htmlspecialchars($station->name) ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="short_code_label" name="short_code_label" 
                                           value="<?= htmlspecialchars($station->short_code_label) ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" 
                                           value="<?= htmlspecialchars($station->code) ?>" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" 
                                           value="<?= htmlspecialchars($station->phone ?? '') ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" 
                                           value="<?= htmlspecialchars($station->email ?? '') ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="location" name="location" 
                                   value="<?= htmlspecialchars($station->location ?? '') ?>">
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="default_station_percent" 
                                           name="default_station_percent" value="<?= $station->default_station_percent ?? 25 ?>" 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="default_programme_percent" 
                                           name="default_programme_percent" value="<?= $station->default_programme_percent ?? 10 ?>" 
                                           min="0" max="100" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="default_prize_pool_percent" 
                                           name="default_prize_pool_percent" value="<?= $station->default_prize_pool_percent ?? 40 ?>" 
                                           min="0" max="100" step="0.01">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?= url('station/show/' . $station->id) ?>" class="btn btn-default">
