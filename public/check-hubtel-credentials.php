...
<body>
    <div class="container">
        ...
        echo 'getenv() works: ' . (getenv('HUBTEL_CLIENT_ID') !== false ? 'Yes' : 'No') . '<br>';
        echo 'Config loaded: ' . (defined('HUBTEL_CLIENT_ID') ? 'Yes' : 'No') . '<br>';
        echo '</div>';
        ?>
        ...
        <div style="text-align: center;">
            <a href="ussd-simulator.php" class="btn">
                Test USSD Simulator
            </a>
            <a href="javascript:location.reload()" class="btn" style="background: #28a745;">
                Refresh Page
            </a>
        </div>
    </div>
